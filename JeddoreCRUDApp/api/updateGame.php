...
//game object fields - need all 5 for an update
...
try {
    ...
    //call the updateGame method from the accessor class - it handles the DB operations
    $success = $retroGameAccessor->updateGame($retroGameObj);
    echo $success ? 1 : 0;
} catch (Exception $e) {
